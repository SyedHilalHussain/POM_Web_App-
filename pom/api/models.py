...
class EconomicProductionLotSize(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="EconomicProductionLotSize")
    name = models.CharField(max_length=255)
    input_data = models.JSONField() 
    output_data = models.JSONField(null=True, blank=True) 
    created_at = models.DateTimeField(auto_now_add=True)
...
class TimeStudy(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="TimeStudy")
    name = models.CharField(max_length=255)
    input_data = models.JSONField() 
    output_data = models.JSONField(null=True, blank=True) 
    created_at = models.DateTimeField(auto_now_add=True)
...
class SampleSizeForTS(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="SampleSizeForTS")
    name = models.CharField(max_length=255)
    input_data = models.JSONField() 
    output_data = models.JSONField(null=True, blank=True) 
    created_at = models.DateTimeField(auto_now_add=True)
